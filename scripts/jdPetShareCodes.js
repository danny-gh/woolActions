...
let PetShareCodes = [
  'MTAxODc2NTEzMzAwMDAwMDAwMDcyNDEzOQ==@MTE1NDQ5OTIwMDAwMDAwNDQxMDgzMTc=',//账号1的好友shareCode,不同好友中间用@符号隔开
  'MTAxODc2NTEzMzAwMDAwMDAwMDcyNDEzOQ==@MTE1NDQ5OTIwMDAwMDAwNDQxMDgzMTc=',//账号2的好友shareCode,不同好友中间用@符号隔开
]

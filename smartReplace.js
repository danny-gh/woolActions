...
async function downloader_jd() {
    ...
    if (remoteContent.indexOf("jdFruitShareCodes") > 0) {
        await download(
            "https://github.com/danny-gh/woolActions/raw/main/scripts/jdFruitShareCodes.js",
    ...
    if (remoteContent.indexOf("jdPetShareCodes") > 0) {
        await download(
            "https://github.com/danny-gh/woolActions/raw/main/scripts/jdPetShareCodes.js",
            "./jdPetShareCodes.js",
            "京东萌宠"
        );
    }
    if (remoteContent.indexOf("jdPlantBeanShareCodes") > 0) {
        await download(
            "https://github.com/danny-gh/woolActions/raw/main/scripts/jdPlantBeanShareCodes.js",
    ...
    if (remoteContent.indexOf("jdSuperMarketShareCodes") > 0)
        await download(
            "https://github.com/danny-gh/woolActions/raw/main/scripts/jdSuperMarketShareCodes.js",
            "./jdSuperMarketShareCodes.js",
            "京小超互助码"
        );
    if (remoteContent.indexOf("jdFactoryShareCodes") > 0) {
        await download(
            "https://github.com/danny-gh/woolActions/raw/main/scripts/jdFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("jdDreamFactoryShareCodes") > 0) {
        await download(
            "https://github.com/danny-gh/woolActions/raw/main/scripts/jdDreamFactoryShareCodes.js",
    ...
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        ...
        await download(
            "https://github.com/danny-gh/woolActions/raw/main/scripts/jdJxncShareCodes.js",
            "./jdJxncShareCodes.js",
            "京喜农场分享码"
        );
        await download(
...
async function downloader_notify() {
    await download("https://github.com/danny-gh/woolActions/raw/main/scripts/sendNotify.js", "./sendNotify.js", "统一通知");
}

async function downloader_user_agents() {
    await download("https://github.com/danny-gh/woolActions/raw/main/scripts/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA");
}
